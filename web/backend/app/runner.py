    ...
    try:
        if (s.ocr_backend or "").strip().lower() == "baidu":
            ...
            for key, value in {
                ...
                "DECKWEAVER_BAIDU_OCR_STANDARD_ENDPOINT": s.baidu_ocr_standard_endpoint,
                "DECKWEAVER_BAIDU_OCR_PROVIDER_ORDER": s.baidu_ocr_provider_order,
                "DECKWEAVER_BAIDU_OCR_QUOTA_FALLBACK": str(s.baidu_ocr_quota_fallback).lower(),
